...
from sources import (suminiko, sumonavi, csv_import, awaji_city,
                     ...
                     gaijinpot, athome_chintai, villagehouse, leopalace)
...
ENABLED_SOURCES = {
    ...
    villagehouse.SLUG:    villagehouse,
    leopalace.SLUG:       leopalace,   # 🌏 Leopalace21: muestra nacional, extranjeros, cero entrada   # 🌏 Village House: cero entrada, extranjeros, todo Japón  # at-home 賃貸: ALQUILERES Wakayama, Fukui y Awaji (otras agencias)
